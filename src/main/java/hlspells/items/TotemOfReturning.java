...
public class TotemOfReturning extends Item {
    ...
    public static void doReturn(World world, PlayerEntity entity, BlockPos teleportPos, String dimension) {
        ...
        com.heromotion.hlspells.network.NetworkManager.INSTANCE.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) entity), new TotemPacket(new ItemStack(ItemInit.TOTEM_OF_RETURNING.get())));
        com.heromotion.hlspells.util.Util.teleport(_newWorld, entity.blockPosition(), teleportPos, entity);
    }
}
