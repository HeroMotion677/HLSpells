...
public class CustomShulkerBullet extends ShulkerBulletEntity
{
    ...
    public CustomShulkerBullet(EntityType<? extends ShulkerBulletEntity> entityType, World world, Entity host)
    {
        super(entityType, world);
        this.moveTo(host.getX(), host.getY(), host.getZ(), this.yRot, this.xRot);
        this.setDeltaMovement(0.1,0.1,0.1);
