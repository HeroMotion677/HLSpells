...
public class Speed extends Enchantment implements ISpell {
    public Speed(EquipmentSlotType... slots) {
    ...
    public String getSpellRegistryName() {
        ResourceLocation registryName = SpellInit.SPEED.get().getRegistryName();
