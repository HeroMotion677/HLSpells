...
public class KnockbackBolt extends Enchantment implements ISpell
{
    public KnockbackBolt(EquipmentSlotType... slots)
    {
    ...
    {
        ResourceLocation registryName = SpellInit.KNOCKBACK_BOLT.get().getRegistryName();
