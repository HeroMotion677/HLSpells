...
public class Absorbing extends Enchantment implements ISpell
{
    public Absorbing (EquipmentSlotType... slots)
    {
    ...
    {
        ResourceLocation registryName = SpellInit.ABSORBING.get().getRegistryName();
