...
public class LightningBolt extends Enchantment implements ISpell {
    public LightningBolt(EquipmentSlotType... slots) {
    ...
    public String getSpellRegistryName() {
        ResourceLocation registryName = SpellInit.LIGHTNING_BOLT.get().getRegistryName();
