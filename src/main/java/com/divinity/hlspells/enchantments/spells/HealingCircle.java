...
public class HealingCircle extends Enchantment implements ISpell {
    public HealingCircle(EquipmentSlotType... slots) {
    ...
    public String getSpellRegistryName() {
        ResourceLocation registryName = SpellInit.HEALING_CIRCLE.get().getRegistryName();
