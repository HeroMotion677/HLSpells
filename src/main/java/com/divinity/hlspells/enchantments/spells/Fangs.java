...
public class Fangs extends Enchantment implements ISpell {
    public Fangs(EquipmentSlotType... slots) {
    ...
    public String getSpellRegistryName() {
        ResourceLocation registryName = SpellInit.FANGS.get().getRegistryName();
