...
public class Bolt extends Enchantment implements ISpell
{
    public Bolt(EquipmentSlotType... slots)
    {
    ...
    {
        ResourceLocation registryName = SpellInit.BOLT.get().getRegistryName();
