...
public class Torpedo extends Enchantment implements ISpell {

    public Torpedo(EquipmentSlot... slots) {
    ...
    public String getSpellRegistryName() {
        ResourceLocation registryName = SpellInit.TORPEDO.get().getRegistryName();
