...
public class SpellInit {
    ...
    public static final RegistryObject<Spell> FROST_PATH_II =  register("frost_path_ii", () -> new FrostPathII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Frost Path II", 3, 6, true, 1, ParticlesInit.BLUE_PARTICLE_SMALL.orElse(null)));
