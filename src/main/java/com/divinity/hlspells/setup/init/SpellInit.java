...
public class SpellInit {
    ...
    public static final RegistryObject<Spell> TELEPORT = register("teleport", () -> new TeleportSpell(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.TWO, SpellAttributes.Marker.UTILITY, "Teleport", 9, false, 1, ParticlesInit.PURPLE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> BOLT_II = register("bolt_ii", () -> new BoltII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.COMBAT, "Bolt II", 5, false, 1, ParticlesInit.WHITE_PARTICLE_SMALL.orElse(null)));
    public static final RegistryObject<Spell> HEALING_CIRCLE = register("healing_circle", () -> new HealingCircleSpell(SpellAttributes.Type.HELD, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.TWO, SpellAttributes.Marker.UTILITY, "Healing Circle", 1, 3, false, 1, ParticlesInit.GREEN_PARTICLE.orElse(null)));
    public static final RegistryObject<Spell> SOUL_SUMMON = register("soul_summon", () -> new SummonSpell<>(EntityInit.SUMMONED_VEX_ENTITY.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Soul Summon", 16, true, 1, ParticlesInit.BLACK_PARTICLE.orElse(null)).summonCount(4));
    ...
    public static final RegistryObject<Spell> LIGHTNING_II = register("lightning_ii", () -> new LightningII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning II", 14, false, 1, ParticlesInit.BLUE_PARTICLE_SMALL.orElse(null)));
    public static final RegistryObject<Spell> LIGHTNING_III = register("lightning_iii", () -> new LightningIII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning III", 20, false, 1, ParticlesInit.BLUE_PARTICLE.orElse(null)));
    public static final RegistryObject<Spell> FIRE_BALL = register("fire_ball", () -> new ProjectileSpell<>(EntityInit.FIREBALL.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Fire Ball", 5, false, 1, ParticlesInit.ORANGE_PARTICLE_SMALL.orElse(null)).viewVectorOffset(1.5D).yPosOffset(1.6D));
    public static final RegistryObject<Spell> FIRE_BALL_II = register("fire_ball_ii", () -> new ProjectileSpell<>(EntityInit.FIREBALL2.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Fire Ball II", 15, false, 1, ParticlesInit.PURPLE_PARTICLE_SMALL.orElse(null)).viewVectorOffset(1.5D).yPosOffset(1.6D));
    ...
    public static final RegistryObject<Spell> PIERCING_BOLT_II = register("piercing_bolt_ii", () -> new PiercingBoltIISpell(SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.TWO, SpellAttributes.Marker.COMBAT, "Piercing Bolt II", 12, false, 1, ParticlesInit.GREEN_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> FROST_PATH_II =  register("frost_path_ii", () -> new FrostPathII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Frost Path II", 1, 6, false, 1, ParticlesInit.BLUE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> FLAMING_CIRCLE = register("flaming_circle", () -> new FlamingCircleSpell(SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.COMBAT, "Flaming Circle", 1, 6, false, 1, ParticleTypes.FLAME));
    ...
    public static final RegistryObject<Spell> NECROMANCY = register("necromancy", () -> new SummonSpell<>(EntityInit.SUMMONED_SKELETON_ENTITY.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Necromancy", 16, false, 1, ParticlesInit.BLACK_PARTICLE.orElse(null)).summonCount(4));
    public static final RegistryObject<Spell> RESPAWN = register("respawn", () -> new RespawnSpell(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Respawn", 16, false, 1, ParticlesInit.WHITE_PARTICLE_SMALL.orElse(null)));
    public static final RegistryObject<Spell> FROST_WALL = register("frost_wall", () -> new FrostWallSpell(SpellAttributes.Type.HELD, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Frost Wall", 16, 6, false, 1, ParticlesInit.BLUE_PARTICLE.orElse(null)));
    ...
    // Optional Spells
    public static final RegistryObject<Spell> ILLUMINATE = initializeOptionalSpell("illuminate", "lucent", () -> new Illuminate(SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.TWO, SpellAttributes.Marker.UTILITY, "Illuminate", 10, 6, false, 1, ParticlesInit.YELLOW_PARTICLE_SMALL.orElse(null)));
    public static final RegistryObject<Spell> ILLUMINATE_II = initializeOptionalSpell("illuminate_ii", "lucent", () -> new IlluminateII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.TWO, SpellAttributes.Marker.UTILITY, "Illuminate II", 10, 6, false, 1, ParticlesInit.YELLOW_PARTICLE.orElse(null)));
