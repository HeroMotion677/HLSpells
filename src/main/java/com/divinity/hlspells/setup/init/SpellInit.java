...
public class SpellInit {
    ...
    public static final RegistryObject<Spell> DESCENT = register("descent", () -> new EffectSpell<>(MobEffects.SLOW_FALLING, SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.UTILITY, "Descent", 1, 15, false, 2));
    ...
    public static final RegistryObject<Spell> FIRE_BALL_II = register("fire_ball_ii", () -> new ProjectileSpell<>(EntityType.DRAGON_FIREBALL, SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Fire Ball II", 5, false, 1).viewVectorOffset(1.5D).yPosOffset(0.5D));
    ...
    public static final RegistryObject<Spell> FROST_WALL = register("frost_wall", () -> new FrostWallSpell(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Frost Wall", 16, false, 1));
