...
public class SpellInit {
    ...
    public static final RegistryObject<Spell> BOLT = register("bolt", () -> new Bolt(SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.COMBAT, "Bolt", 5, false, 1));
    public static final RegistryObject<Spell> BOLT_II = register("bolt_ii", () -> new BoltII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.COMBAT, "Bolt II", 5, false, 1));
    ...
    public static final RegistryObject<Spell> SOUL_SUMMON = register("soul_summon", () -> new SummonSpell<>(EntityInit.SUMMONED_VEX_ENTITY.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Soul Summon", 16, true, 1).summonCount(4));
    ...
    public static final RegistryObject<Spell> LIGHTNING = register("lightning", () -> new Lightning(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning", 8, false, 1));
    public static final RegistryObject<Spell> LIGHTNING_II = register("lightning_ii", () -> new LightningII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning II", 14, false, 1));
    public static final RegistryObject<Spell> LIGHTNING_III = register("lightning_iii", () -> new LightningIII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning III", 20, false, 1));
    public static final RegistryObject<Spell> FIRE_BALL = register("fire_ball", () -> new ProjectileSpell<>(EntityInit.FIREBALL.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Fire Ball", 5, false, 1).viewVectorOffset(1.5D).yPosOffset(1.35D));
    public static final RegistryObject<Spell> FIRE_BALL_II = register("fire_ball_ii", () -> new ProjectileSpell<>(EntityInit.FIREBALL2.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Fire Ball II", 5, false, 1).viewVectorOffset(1.5D).yPosOffset(1.35D));
    ...
    public static final RegistryObject<Spell> PIERCING_BOLT_II = register("piercing_bolt_ii", () -> new PiercingBoltIISpell(SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.TWO, SpellAttributes.Marker.COMBAT, "Piercing Bolt II", 12, false, 1));
    public static final RegistryObject<Spell> ABSORBING = register("absorbing", () -> new AbsorbingSpell(SpellAttributes.Type.HELD, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Absorbing", 6, false, 1, 1));
    ...
    public static final RegistryObject<Spell> FROST_PATH = register("frost_path", () -> new FrostPath(SpellAttributes.Type.HELD, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Frost Path", 1,  6, false, 1));
    public static final RegistryObject<Spell> FROST_PATH_II =  register("frost_path_ii", () -> new FrostPathII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Frost Path II", 1, 6, false, 1));
    public static final RegistryObject<Spell> WITHER_SKULL = register("wither_skull", () -> new ProjectileSpell<>(EntityInit.WITHER_SKULL_ENTITY.orElse(null), SpellAttributes.Type.CAST, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Wither Skull", 10, false, 1).viewVectorOffset(1.5D).yPosOffset(1.35D));
    ...
    public static final RegistryObject<Spell> PHASING = register("phasing", () -> new Phasing(SpellAttributes.Type.HELD, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Phasing", 1, 6, false, 1));
