...
public class SpellInit {
    ...
    public static final RegistryObject<Spell> LIGHTNING = register("lightning", () -> new Lightning(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning", 4, false, 1, ParticlesInit.BLUE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> ABSORBING = register("absorbing", () -> new AbsorbingSpell(SpellAttributes.Type.HELD, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Absorbing", 1, false, 1, ParticlesInit.WHITE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> FLAMING_CIRCLE = register("flaming_circle", () -> new FlamingCircleSpell(SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.COMBAT, "Flaming Circle", 4, 4, false, 1, ParticleTypes.SMALL_FLAME));
    ...
    public static final RegistryObject<Spell> RESPAWN = register("respawn", () -> new RespawnSpell(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Respawn", 20, false, 1, ParticlesInit.WHITE_PARTICLE_SMALL.orElse(null)));
