...
public class SpellInit {
    ...
    public static final RegistryObject<Spell> DESCENT_II = register("descent_ii", () -> new DescentII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.UTILITY, "Descent II", 1, 15, true, 1));
    ...
    public static final RegistryObject<Spell> BOLT_II = register("bolt_ii", () -> new BoltII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.ONE, SpellAttributes.Marker.COMBAT, "Bolt II", 5, true, 1, ParticlesInit.WHITE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> LIGHTNING_II = register("lightning_ii", () -> new LightningII(SpellAttributes.Type.CAST, SpellAttributes.Rarity.RARE, SpellAttributes.Tier.THREE, SpellAttributes.Marker.COMBAT, "Lightning II", 14, true, 1, ParticlesInit.BLUE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> FROST_PATH_II =  register("frost_path_ii", () -> new FrostPathII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.COMMON, SpellAttributes.Tier.THREE, SpellAttributes.Marker.UTILITY, "Frost Path II", 1, 6, true, 1, ParticlesInit.BLUE_PARTICLE_SMALL.orElse(null)));
    ...
    public static final RegistryObject<Spell> ILLUMINATE_II = initializeOptionalSpell("illuminate_ii", "lucent", () -> new IlluminateII(SpellAttributes.Type.HELD, SpellAttributes.Rarity.UNCOMMON, SpellAttributes.Tier.TWO, SpellAttributes.Marker.UTILITY, "Illuminate II", 10, 6, true, 1, ParticlesInit.YELLOW_PARTICLE.orElse(null)));
