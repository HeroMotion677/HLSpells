...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<FlamingBreathEntity>> FLAMING_BREATH_ENTITY = registerEntity("flaming_breath", () -> EntityType.Builder.of(FlamingBreathEntity::new, MobCategory.MISC).sized(0.3125F, 0.3125F));
    public static final RegistryObject<EntityType<FreezingBreathEntity>> FREEZING_BREATH_ENTITY = registerEntity("freezing_breath", () -> EntityType.Builder.of(FreezingBreathEntity::new, MobCategory.MISC).sized(0.3125F, 0.3125F));
    public static final RegistryObject<EntityType<WitherBreathEntity>> WITHER_BREATH_ENTITY = registerEntity("wither_breath", () -> EntityType.Builder.of(WitherBreathEntity::new, MobCategory.MISC).sized(0.3125F, 0.3125F));
    public static final RegistryObject<EntityType<FireballEntity>> FIREBALL = registerEntity("fireball", () -> EntityType.Builder.of(FireballEntity::new, MobCategory.MISC).sized(0.5125F, 0.5125F));
    public static final RegistryObject<EntityType<Fireball2Entity>> FIREBALL2 = registerEntity("fireball2", () -> EntityType.Builder.of(Fireball2Entity::new, MobCategory.MISC).sized(0.7125F, 0.7125F));
