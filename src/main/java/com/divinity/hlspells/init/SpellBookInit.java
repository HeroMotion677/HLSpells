...
public class SpellBookInit {
    ...
    public static final RegistryObject<SpellBookObject> EMPTY = SPELL_BOOK_DEFERRED_REGISTER.register("empty", () -> new SpellBookObject(new SpellInstance(SpellInit.EMPTY.get())));
    ...
    public static final RegistryObject<SpellBookObject> REPEL = SPELL_BOOK_DEFERRED_REGISTER.register("repel", () -> new SpellBookObject(new SpellInstance(SpellInit.REPEL.get())));
    public static final RegistryObject<SpellBookObject> FLAMING_CIRCLE = SPELL_BOOK_DEFERRED_REGISTER.register("flaming_circle", () -> new SpellBookObject(new SpellInstance(SpellInit.FLAMING_CIRCLE.get())));
