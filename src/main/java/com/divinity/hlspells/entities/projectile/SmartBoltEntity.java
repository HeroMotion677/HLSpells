...
public class SmartBoltEntity extends BaseBoltEntity {
    ...
    public SmartBoltEntity(EntityType<? extends BaseBoltEntity> type, Level world) {
        super(type, world, ParticleTypes.ENCHANTED_HIT, ParticleTypes.SCRAPE);
    }
    ...
    @Nullable
    protected Direction currentMoveDirection;
    protected int flightSteps;
    ...
    /*public SmartBoltEntity(EntityType<? extends ShulkerBullet> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.noPhysics = true;
    }*/

   /* public SmartBoltEntity(Level pLevel, LivingEntity pShooter, Entity pFinalTarget, Direction.Axis pAxis) {
        this(EntityType<? extends BaseBoltEntity>, pLevel;
    ...
    protected void setMoveDirection(@Nullable Direction pDirection) {
        this.currentMoveDirection = pDirection;
    }

    protected void selectNextMoveDirection(@Nullable Direction.Axis pAxis) {
        double d0 = 0.5D;
        BlockPos blockpos;
        if (this.finalTarget == null) {
