...
public class StructureGen {
    ...
    private static final ResourceLocation mainMageHouse = ResourceLocation.fromNamespaceAndPath(HLSpells.MODID, "villages/mage_house_plains");
    ...
    public static void setupVillageWorldGen(RegistryAccess dynamicRegistries) {
        ...
        addMageHouseToVillageConfig(dynamicRegistries, "village/savanna/houses", ResourceLocation.fromNamespaceAndPath(HLSpells.MODID, "villages/mage_house_savanna"), 4);
        addMageHouseToVillageConfig(dynamicRegistries, "village/desert/houses", ResourceLocation.fromNamespaceAndPath(HLSpells.MODID, "villages/mage_house_desert"), 4);
        addMageHouseToVillageConfig(dynamicRegistries, "village/taiga/houses", ResourceLocation.fromNamespaceAndPath(HLSpells.MODID, "villages/mage_house_taiga"), 4);
        addMageHouseToVillageConfig(dynamicRegistries, "village/snowy/houses", ResourceLocation.fromNamespaceAndPath(HLSpells.MODID, "villages/mage_house_snowy"), 4);
    ...
    private static void addMageHouseToVillageConfig(RegistryAccess dynamicRegistries, String villagePiece, ResourceLocation newHouseRL, int weight) {
        ...
        StructureTemplatePool pool = dynamicRegistries.registryOrThrow(Registries.TEMPLATE_POOL).getOptional(ResourceLocation.parse(villagePiece)).orElse(null);
        if (pool != null) {
